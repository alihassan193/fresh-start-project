    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Trust Indicators */}
          <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-4 md:gap-8 mb-8 md:mb-12 px-4">
            <div className="flex items-center bg-black/30 backdrop-blur-sm rounded-lg px-3 py-2">
              <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-desert-gold mr-2" />
              <span className="text-xs sm:text-sm font-medium">Licensed</span>
            </div>
            <div className="flex items-center bg-black/30 backdrop-blur-sm rounded-lg px-3 py-2">
              <Users className="w-4 h-4 sm:w-5 sm:h-5 text-desert-gold mr-2" />
              <span className="text-xs sm:text-sm font-medium">
                10,000+ Guests
              </span>
            </div>
            <div className="flex items-center bg-black/30 backdrop-blur-sm rounded-lg px-3 py-2">
              <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-desert-gold mr-2" />
          ...
          <div className="mb-12 md:mb-16 px-4">
            ...
            >
              <Link to="#packages">
                <Calendar className="w-10 h-10 md:w-10 md:h-10 mr-3 md:mr-4" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto px-4">
            <div className="bg-black/20 backdrop-blur-md rounded-xl p-4 sm:p-6 border border-white/20">
